...
//     employeeId: number;
// }
// type EmployeePerson = Person & Employee; // Intersection type combining Person and Employee
...
//     employeeId: number;
// }
// interface EmployeePersonInterface extends PersonInterface, EmployeeInterface {} // Intersection type using interfaces
// const employeePersonInterface: EmployeePersonInterface = {
//     name: "Jane Doe",
//     age: 28,
//     employeeId: 54321
// };
...
//     age: number;
// }
// type UserType = User & { email: string }; // Extending User type with an additional property
// interface UserInterfaceExtended extends UserInterface { // Extending UserInterface with an additional property
//     email: string;
// }
...
// };
// const userInterfaceExtended: UserInterfaceExtended = {
//     name: "Bob",
//     age: 30,
